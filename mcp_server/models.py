...
class CertificateParameters(BaseModel):
    CustID: str = Field(
        ...
        examples=[
            'Enter 14 Digit A/c No - TDS Information will be generated for all A/cs associated with Customer ID.'
        ],
    )
    DOB: str = Field(
        ..., description='Date of birth in DD-MM-YYYY format', examples=['31-12-1980']
    )
    finYr: str = Field(..., description='Financial Year', examples=['2018-2019'])
...
class TdcerCertificatePostRequest(BaseModel):
...
class TdcerCertificatePostResponse(BaseModel):
...
class TdcerCertificatePostResponse1(BaseModel):
...
class TdcerCertificatePostResponse2(BaseModel):
...
class TdcerCertificatePostResponse3(BaseModel):
...
class TdcerCertificatePostResponse4(BaseModel):
...
class TdcerCertificatePostResponse5(BaseModel):
...
class TdcerCertificatePostResponse6(BaseModel):
